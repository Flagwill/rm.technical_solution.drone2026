...
\begin{figure}[hbt!]
    \centering 
    \includegraphics[width=0.5\columnwidth]{figure/5_总结与展望/Pitch轴固定展示.jpg}
    \caption{Pitch轴固定展示}
...
\begin{figure}[hbt!]
    ...
    \subfigure[重复度结果展示图1]{
        \centering
        \includegraphics[width=0.5\columnwidth]{figure/5_总结与展望/重复度结果展示图-1.png}
    }
    \subfigure[重复度结果展示图2]{
        \centering
        \includegraphics[width=0.5\columnwidth]{figure/5_总结与展望/重复度结果展示图-2.png}
    }
    \caption{重复度测试结果展示}
    \label{fig:重复度结果展示图}
\end{figure} 