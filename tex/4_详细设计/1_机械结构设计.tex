...
\begin{figure}[hbt!]
    ...
    \subfigure[步兵弹仓以及基座示意图\label{fig:步兵弹仓以及基座示意图} ]{
        \centering
        \includegraphics[width=0.45\columnwidth]{figure/4_详细设计/机械结构设计/步兵弹仓以及基座示意图.png}
    }
    \subfigure[哨兵1代弹仓以及基座示意图\label{fig:哨兵1代弹仓以及基座示意图}]{
        \centering
        \includegraphics[width=0.45\columnwidth]{figure/4_详细设计/机械结构设计/哨兵1代弹仓以及基座示意图.png}
    }
...
\begin{figure}[hbt!]
    ...
    \subfigure[哨兵2代弹仓以及基座示意图\label{fig:哨兵2代弹仓以及基座示意图}]{
        \centering
        \includegraphics[width=0.45\columnwidth]{figure/4_详细设计/机械结构设计/哨兵2代弹仓以及基座示意图.png}
    }
...
\begin{figure}[hbt!]
    ...
    \subfigure[拉铆螺母固定板\label{fig:拉铆螺母固定板_设计方案} ]{
        \centering
        \includegraphics[width=0.4\columnwidth]{figure/4_详细设计/机械结构设计/拉铆螺母固定板.jpg}
    }
    \subfigure[拉铆螺母装在铝管内\label{fig:拉铆螺母装在铝管内_设计方案}]{
        \centering
        \includegraphics[width=0.4\columnwidth]{figure/4_详细设计/机械结构设计/拉铆螺母装在铝管内.jpg}
    }
...
\begin{figure}[hbt!]
    ...
    \subfigure[车架图\label{fig:chassis1_设计方案} ]{
        ...
        \centering
        \includegraphics[width=0.7\columnwidth]{figure/4_详细设计/机械结构设计/车架.png}
        \end{minipage}
    }
    \subfigure[落地防卡导轮\label{fig:chassis2_设计方案}]{
        \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=0.7\columnwidth]{figure/4_详细设计/机械结构设计/落地防卡导轮.png}
        \end{minipage}
    }
...
\begin{figure}[hbt!]
    \centering
        ...
        \centering
        \includegraphics[width=0.15\columnwidth]{figure/4_详细设计/机械结构设计/轮毂电机质量.jpg}
    }
    \subfigure[轮毂电机图\label{fig:轮毂电机图_设计方案} ]{
        \centering
        \includegraphics[width=0.35\columnwidth]{figure/4_详细设计/机械结构设计/轮毂电机图.png}
    }
    \subfigure[6寸全向轮轮毂电机爆炸图\label{fig:6寸全向轮轮毂电机爆炸图_设计方案}]{
        \centering
        \includegraphics[width=0.35\columnwidth]{figure/4_详细设计/机械结构设计/6寸全向轮轮毂电机爆炸图.png}
    }
...
\begin{figure}[hbt!]
    ...
    \subfigure[轮毂电机四连杆摇臂固定\label{fig:轮毂电机四连杆摇臂固定_设计方案} ]{
        \centering
        \includegraphics[width=0.40\columnwidth]{figure/4_详细设计/机械结构设计/轮毂电机四连杆摇臂固定.png}
    }
    \subfigure[轮毂电机端面固定\label{fig:轮毂电机端面固定_设计方案}]{
        \centering
        \includegraphics[width=0.40\columnwidth]{figure/4_详细设计/机械结构设计/轮毂电机端面固定.png}
    }
...
\begin{figure}[hbt!]
    ...
    \subfigure[原装M3508悬挂系统系统质量\label{fig:原装M3508悬挂系统系统质量_设计方案} ]{
        \centering
        \includegraphics[width=0.40\columnwidth]{figure/4_详细设计/机械结构设计/原装M3508悬挂系统系统质量.png}
    }
    \subfigure[轮毂电机悬挂系统系统质量\label{fig:轮毂电机悬挂系统系统质量_设计方案}]{
        \centering
        \includegraphics[width=0.40\columnwidth]{figure/4_详细设计/机械结构设计/轮毂电机悬挂系统系统质量.png}
    }
...
\begin{figure}[hbt!]
    ...
    \subfigure[悬挂系统图]{
        \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=0.7\columnwidth]{figure/4_详细设计/机械结构设计/悬挂系统图.jpg}
        \end{minipage}
    }
    \subfigure[轮距图]{
        \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=0.7\columnwidth]{figure/4_详细设计/机械结构设计/轮距图.png}
        \end{minipage}
    }
    \caption{悬挂系统展示}
...
\begin{figure}[hbt!]
    ...
    \subfigure[Yaw轴转轴\label{fig:Yaw轴转轴_设计方案} ]{
        \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=0.7\columnwidth]{figure/4_详细设计/机械结构设计/yaw轴转轴.jpg}
        \end{minipage}
    }
    \subfigure[Yaw轴转轴爆炸图\label{fig:Yaw轴转轴爆炸图_设计方案}]{
        \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=0.7\columnwidth]{figure/4_详细设计/机械结构设计/yaw轴转轴爆炸图.jpg}
        \end{minipage}
    }
...
\begin{figure}[hbt!]
    ...
    \subfigure[云台支架斜二测 隐藏minipc和雷达\label{fig:云台支架斜二测 隐藏minipc和雷达_设计方案} ]{
        \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=0.7\columnwidth]{figure/4_详细设计/机械结构设计/云台支架斜二测 隐藏minipc和雷达.png}
        \end{minipage}
    }
    \subfigure[云台支架侧视图 隐藏minipc和雷达\label{fig:云台支架侧视图 隐藏minipc和雷达_设计方案}]{
        \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=0.7\columnwidth]{figure/4_详细设计/机械结构设计/云台支架侧视图 隐藏minipc和雷达.png}
        \end{minipage}
    }
...
\begin{figure}[hbt!]
    ...
    \subfigure[云台支架Mini PC保护\label{fig:云台支架Mini PC保护_设计方案} ]{
        \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=0.7\columnwidth]{figure/4_详细设计/机械结构设计/云台支架Mini PC保护.png}
        \end{minipage}
    }
    \subfigure[云台支架UWB固定\label{fig:云台支架UWB固定_设计方案}]{
        \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=0.7\columnwidth]{figure/4_详细设计/机械结构设计/云台支架UWB固定.png}
        \end{minipage}
    }
...
\begin{figure}[hbt!]
    ...
    \subfigure[GM6020外套滑环剖面图\label{fig:GM6020外套滑环剖面图_设计方案} ]{
        \centering
        \includegraphics[width=0.45\columnwidth]{figure/4_详细设计/机械结构设计/GM6020外套滑环剖面图.png}
    }
    \subfigure[GM6020外套滑环实物图\label{fig:GM6020外套滑环实物图_设计方案}]{
        \centering
        \includegraphics[width=0.25\columnwidth]{figure/4_详细设计/机械结构设计/GM6020外套滑环实物图.png}
    }
...
\begin{figure}[hbt!]
    ...
    \subfigure[GM6020外套新滑环剖面图\label{fig:GM6020外套新滑环剖面图_设计方案} ]{
        \centering
        \includegraphics[width=0.45\columnwidth]{figure/4_详细设计/机械结构设计/GM6020外套新滑环剖面图.png}
    }
    \subfigure[GM6020外套新滑环实物图\label{fig:GM6020外套新滑环实物图_设计方案}]{
        \centering
        \includegraphics[width=0.25\columnwidth]{figure/4_详细设计/机械结构设计/GM6020外套新滑环实物图.jpg}
    }
...
\begin{figure}[hbt!]
    ...
    \subfigure[云台支架M3508云台电机\label{fig:云台支架3508_设计方案} ]{
        \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=0.6\columnwidth]{figure/4_详细设计/机械结构设计/云台支架侧视图 隐藏minipc和雷达.png}
        \end{minipage}
    }
    \subfigure[云台支架GM6020\label{fig:云台支架6020_设计方案}]{
        \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=0.6\columnwidth]{figure/4_详细设计/机械结构设计/云台支架GM6020.png}
        \end{minipage}
    }
...
\begin{figure}[hbt!]
    ...
    \subfigure[M3508P11斜二测\label{fig:3508P11斜二测_设计方案} ]{
        \centering
        \includegraphics[width=0.2\columnwidth]{figure/4_详细设计/机械结构设计/M3508P11斜二测.jpg}
    }
    \subfigure[M3508P11剖面图\label{fig:3508P11剖面图_设计方案}]{
        \centering
        \includegraphics[width=0.48\columnwidth]{figure/4_详细设计/机械结构设计/M3508P11剖面图.png}
    }
    \subfigure[M3508P11实物图\label{fig:3508P11实物图_设计方案}]{
        \centering
        \includegraphics[width=0.2\columnwidth]{figure/4_详细设计/机械结构设计/M3508P11实物图.jpg}
    }
...
\begin{figure}[hbt!]
     ...
     \subfigure[发射轴测图 \label{fig:shooter_1} ]{
        \begin{minipage}[t]{0.45\linewidth}
         \centering
         \includegraphics[width=0.8\columnwidth]{figure/4_详细设计/机械结构设计/发射轴测图.png}
         \end{minipage}
     }
     \subfigure[发射爆炸图\label{fig:shooter_2}]{
        \begin{minipage}[t]{0.45\linewidth}
         \centering
         \includegraphics[width=0.8\columnwidth]{figure/4_详细设计/机械结构设计/发射爆炸视图.png}
         \end{minipage}
     }
...
\begin{figure}[hbt!]
    ...
    \subfigure[原枪管斜二测图\label{fig:枪管斜二测图_设计方案} ]{
        \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=0.8\columnwidth]{figure/4_详细设计/机械结构设计/原枪管斜二测视图.png}
        \end{minipage}
    }
    \subfigure[原发射机构剖面图\label{fig:发射机构剖面图_设计方案}]{
        \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=0.8\columnwidth]{figure/4_详细设计/机械结构设计/原枪管剖视图.png}
        \end{minipage}
    }
...
\begin{figure}[hbt!]
    ...
    \subfigure[第一版枪管斜二测图\label{fig:第一版枪管斜二测图_设计方案} ]{
        \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=0.8\columnwidth]{figure/4_详细设计/机械结构设计/第一版枪管轴侧图.png}
        \end{minipage}
    }
    \subfigure[第一版发射机构剖面图\label{fig:第一版发射机构剖面图_设计方案}]{
        \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=0.8\columnwidth]{figure/4_详细设计/机械结构设计/第一版枪管剖视图.png}
        \end{minipage}
    }
...
\begin{figure}[hbt!]
    ...
    \subfigure[第二版枪管斜二测图\label{fig:第二版枪管斜二测图_设计方案} ]{
        \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=0.8\columnwidth]{figure/4_详细设计/机械结构设计/第二版枪管轴测图.png}
        \end{minipage}
    }
    \subfigure[第二版发射机构剖面图\label{fig:第二版发射机构剖面图_设计方案}]{
        \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=0.8\columnwidth]{figure/4_详细设计/机械结构设计/第二版枪管剖视图.png}
        \end{minipage}
    }
...
\begin{figure}[hbt!]
    ...
    \subfigure[第三版枪管斜二测图\label{fig:第三版枪管斜二测图_设计方案} ]{
        \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=0.8\columnwidth]{figure/4_详细设计/机械结构设计/第三版枪管轴二测图.png}
        \end{minipage}
    }
    \subfigure[第三版发射机构剖面图\label{fig:第三版发射机构剖面图_设计方案}]{
        \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=0.8\columnwidth]{figure/4_详细设计/机械结构设计/第三版枪管剖视图.png}
        \end{minipage}
    }
...
\begin{figure}[hbt!]
    ...
    \subfigure[方案一\label{fig:弹丸定心结构_设计方案一} ]{
        \centering
        \includegraphics[width=0.3\columnwidth]{figure/4_详细设计/机械结构设计/1号限位.png}
    }
    \subfigure[方案二\label{fig:弹丸定心结构_设计方案二}]{
        \centering
        \includegraphics[width=0.3\columnwidth]{figure/4_详细设计/机械结构设计/2号限位.png}
    }
    \subfigure[方案三\label{fig:弹丸定心结构_设计方案三} ]{
        \centering
        \includegraphics[width=0.3\columnwidth]{figure/4_详细设计/机械结构设计/3号限位.png}
    }
...
\begin{figure}[hbt!]
    ...
    \subfigure[双枪转轮机构展示 \label{fig:双枪1_设计方案} ]{
        \centering
        \includegraphics[width=0.4\columnwidth]{figure/4_详细设计/机械结构设计/双枪转轮机构.png}
    }
    
    \subfigure[双枪转轮机构侧视图\label{fig:双枪2_设计方案}]{
        \centering
        \includegraphics[width=0.35\columnwidth]{figure/4_详细设计/机械结构设计/双枪转轮机构侧视图.png}
    }
    \subfigure[双枪定位示意图\label{fig:双枪3_设计方案} ]{
        \centering
        \includegraphics[width=0.35\columnwidth]{figure/4_详细设计/机械结构设计/双枪定位示意图.png}
    }
...
\begin{figure}[hbt!]
   ...
   \subfigure[底盘剖面图]{
        \begin{minipage}[t]{0.45\linewidth}
       \centering
       \includegraphics[width=0.7\columnwidth]{figure/4_详细设计/机械结构设计/底盘剖面图.png}
       \end{minipage}
   }
   \subfigure[中心供弹斜二测图]{
        \begin{minipage}[t]{0.45\linewidth}
       \centering
        \includegraphics[width=0.7\columnwidth]{figure/4_详细设计/机械结构设计/中心供弹斜二测图.png}
        \end{minipage}
   }
   \caption{中心供弹展示}
   \label{fig:中心供弹_设计方案}
...
拨盘可根据底盘高度调整预置弹丸数量，在哨兵的版本中，我们可预置三层弹丸，同时相对于22赛季的导流件形状做出优化，如 \figref{fig:中心供弹导流件}所示。提高其落弹率，在高频发射时不会出现空拨问题。
 \begin{figure}[hbt!]
    ...
    \subfigure[22赛季中心供弹导流件]{
        \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=0.7\columnwidth]{figure/4_详细设计/机械结构设计/22赛季中心供弹导流件.png}
        \end{minipage}
    }
    \subfigure[23赛季中心供弹导流件]{
        \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=0.7\columnwidth]{figure/4_详细设计/机械结构设计/23赛季中心供弹导流件.png}
        \end{minipage}
    }
    \caption{中心供弹导流件}
    \label{fig:中心供弹导流件}
\end{figure}
 ...
 \begin{figure}[hbt!]
    \centering
    \includegraphics[width=0.5\columnwidth]{figure/4_详细设计/机械结构设计/中心供弹剖面图.png}
    \caption{中心供弹结构}
...
\begin{figure}[hbt!]
    \centering
    \includegraphics[width=0.5\columnwidth]{figure/4_详细设计/机械结构设计/云台弹链.png}
    \caption{云台弹链}
    \label{fig:云台弹链}
\end{figure}
...
\label{滑槽设计思路}滑槽设计通过在Pitch轴活动范围内均匀选取四个点，画出滑块会经过的点，同时不断调整活动滑槽的转轴和滑块的位置，来保证弹丸在滑槽中平稳运动，并且滑槽不会和云台结构干涉。在确定转轴位置和滑块经过的四个点后，将这四个点连线来拟合滑块的运动轨迹。最后在滑槽上添加圆角，避免滑块卡住。\figref{fig:P轴弹链滑块演示}展示了Pitch轴处于三种角度下的弹链滑块情况。
 ...
 \begin{figure}[hbt!]
    ...
    \subfigure[P轴正50度]{
        ...
        \centering
        \includegraphics[width=0.7\columnwidth]{figure/4_详细设计/机械结构设计/P轴正50度.png}
        \end{minipage}
    }
    \subfigure[P轴水平]{
        \begin{minipage}[t]{0.3\linewidth}
        \centering
        \includegraphics[width=0.7\columnwidth]{figure/4_详细设计/机械结构设计/P轴水平.png}
        \end{minipage}
    }
    \subfigure[P轴负30度]{
        \begin{minipage}[t]{0.3\linewidth}
        \centering
        \includegraphics[width=0.7\columnwidth]{figure/4_详细设计/机械结构设计/P轴负30度.png}
        \end{minipage}
    }
    \caption{P轴弹链滑块演示}
    \label{fig:P轴弹链滑块演示}
...
\begin{figure}[hbt!]
    ...
    \subfigure[22赛季弹链\label{fig:22赛季弹链} ]{
        \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=0.7\columnwidth]{figure/4_详细设计/机械结构设计/22赛季弹链.png}
        \end{minipage}
    }
    \subfigure[23赛季弹链\label{fig:23赛季弹链}]{
        \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=0.7\columnwidth]{figure/4_详细设计/机械结构设计/23赛季弹链.png}
        \end{minipage}
    }
...
\begin{figure}[hbt!]
    \centering
    \includegraphics[width=0.5\columnwidth]{figure/4_详细设计/机械结构设计/上滑块爆炸图.png}
    \caption{上滑块爆炸图}
    \label{fig:上滑块爆炸图}
\end{figure}
...
\begin{figure}[hbt!]
    \centering
    \includegraphics[width=0.6\columnwidth]{figure/4_详细设计/机械结构设计/哨兵总装轴测图.png}
...
\begin{figure}[!htbp]
    ...
    \subfigure[铝管 \label{fig:2D_AL} ]{
        \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=0.6\columnwidth]{figure/4_详细设计/机械结构设计/path_Al.jpg}
        \end{minipage}
    }
    \subfigure[碳板\label{fig:2D_carbon}]{
        \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=0.6\columnwidth]{figure/4_详细设计/机械结构设计/path_Carbon plate.jpg}
        \end{minipage}
    }
...
\begin{figure}[!htbp]
    ...
    \subfigure[云台铝件 \label{fig:Gimbal_aluminum_parts} ]{
        \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=0.6\columnwidth]{figure/4_详细设计/机械结构设计/云台铝件.png}
        \end{minipage}
    }
    \subfigure[轮毂电机铝件\label{fig:Hub_motor}]{
        \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=0.6\columnwidth]{figure/4_详细设计/机械结构设计/轮毂电机铝件.jpg}
        \end{minipage}
    }
...
\begin{figure}[!htbp]
    ...
    \subfigure[防尘盖 \label{fig:3D_dustproof} ]{
        \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=0.6\columnwidth]{figure/4_详细设计/机械结构设计/防尘盖.png}
        \end{minipage}
    }
    \subfigure[滑环外壳\label{fig:3D_enclosure}]{
        \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=0.4\columnwidth]{figure/4_详细设计/机械结构设计/滑环外壳.png}
        \end{minipage}
    }
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.3\columnwidth]{figure/4_详细设计/机械结构设计/线切割齿轮.png}
        \caption{线切割齿轮}
...
\begin{figure}[hbt!]
    \centering
    \includegraphics[width=0.4\columnwidth]{figure/4_详细设计/机械结构设计/保护框.png}
    \caption{保护框弯管}
    \label{fig:curved}
\end{figure}
...
\begin{figure}[hbt!]
    ...
    \subfigure[IMU固定侧视图 \label{fig:IMU1_设计方案} ]{
        \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=0.7\columnwidth]{figure/4_详细设计/机械结构设计/IMU固定侧视图.jpg}
        \end{minipage}
    }
    \subfigure[IMU固定俯视图\label{fig:IMU2_设计方案}]{
        \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=0.7\columnwidth]{figure/4_详细设计/机械结构设计/IMU固定俯视图.jpg}
        \end{minipage}
    }
...
\begin{figure}[hbt!]
    ...
    \subfigure[摄像头固定侧视图 \label{fig:摄像头1_设计方案} ]{
        \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=0.7\columnwidth]{figure/4_详细设计/机械结构设计/摄像头固定侧视图.jpg}
        \end{minipage}
    }
    \subfigure[摄像头固定仰视图\label{fig:摄像头2_设计方案}]{
        \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=0.7\columnwidth]{figure/4_详细设计/机械结构设计/摄像头固定仰视图.jpg}
        \end{minipage}
    }
...
\begin{figure}[hbt!]
    ...
    \subfigure[雷达保护及固定 斜二测 \label{fig:雷达1_设计方案} ]{
        \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=0.6\columnwidth]{figure/4_详细设计/机械结构设计/雷达保护及固定 斜二测.png}
        \end{minipage}
    }
    \subfigure[雷达固定仰视图\label{fig雷达2_设计方案}]{
        \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=0.6\columnwidth]{figure/4_详细设计/机械结构设计/雷达固定 仰视图.png}
        \end{minipage}
    }
...
\begin{figure}[hbt!]
    ...
    \subfigure[大恒相机固定及保护\label{fig:大恒相机1_设计方案} ]{
        \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=0.6\columnwidth]{figure/4_详细设计/机械结构设计/大恒相机固定及保护.png}
        \end{minipage}
    }
    \subfigure[大恒相机固定仰视图\label{fig:大恒相机2_设计方案}]{
        \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=0.6\columnwidth]{figure/4_详细设计/机械结构设计/大恒相机固定仰视图.png}
        \end{minipage}
    }
...
\begin{figure}[hbt!]
    ...
    \subfigure[电路板放置侧视图 \label{fig:电路板1_设计方案} ]{
        \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=0.6\columnwidth]{figure/4_详细设计/机械结构设计/电路板放置侧视图.jpg}
        \end{minipage}
    }
    \subfigure[电路板放置俯视图\label{fig:电路板2_设计方案}]{
        \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=0.6\columnwidth]{figure/4_详细设计/机械结构设计/电路板放置俯视图.jpg}
        \end{minipage}
    }
...
\begin{figure}[hbt!]
    ...
    \subfigure[安全系数图\label{fig:有限元1_设计方案} ]
        {
        \centering
        \includegraphics[width=0.35\columnwidth]{figure/4_详细设计/机械结构设计/安全系数图.png}
        }
    \centering 
    \subfigure[位移图\label{fig:有限元2_设计方案} ]{
        \centering
        \includegraphics[width=0.35\columnwidth]{figure/4_详细设计/机械结构设计/位移图.png}
        }    
\end{figure}
...
\begin{figure}[hbt!]
    ...
    \subfigure[应力图\label{fig:有限元3_设计方案} ]{
        \centering
        \includegraphics[width=0.35\columnwidth]{figure/4_详细设计/机械结构设计/应力图.png}
        }
    \subfigure[应变图\label{fig:有限元4_设计方案} ]{
        \centering
        \includegraphics[width=0.35\columnwidth]{figure/4_详细设计/机械结构设计/应变图.png}
        }
